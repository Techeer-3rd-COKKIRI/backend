...
public class CommentServiceTest {
    ...
    void createCommentTest() {
        ...
        assertEquals(COMMENT_FIXTURE, commentService.registerComment(CommentFixtures.COMMENT_REQUEST, UserFixtures.STUDY_MANAGER_FIXTURE, StudyFixtures.JAVA_STUDY_FIXTURE));
    }
